...
import numpy as np
from utils_timegan import extract_time, rnn_cell, random_generator, batch_generator


def timegan (ori_data, args):
  """TimeGAN function.
  ...
  # Basic Parameters
  ori_data = np.squeeze(ori_data,axis=3)
  ...
  # Network Parameters
  hidden_dim   = args.sequence_length 
  num_layers   = 3
  iterations   = 10000
  batch_size   = 128
  module_name  = 'gru'
  ...
  syn_data = np.squeeze(generated_data)
  return ori_data,syn_data
